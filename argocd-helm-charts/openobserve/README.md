...
## Configure values.yaml for External Secrets and Dex

To avoid hardcoding secrets in your Git repository or modifying the upstream Helm chart, configure your `values.yaml` to dynamically reference secrets via environment variables:
      ...
      config:
        ...
        staticClients:
          - id: internalclient
            ...
            name: internalclient
            # Instructs Dex to read client secret from O2_DEX_CLIENT_SECRET environment variable
        ...
        connectors:
          - type: oidc
            ...
            config:
              ...
              # Resolves the OIDC client secret from the KEYCLOAK_CLIENT_SECRET environment variable
